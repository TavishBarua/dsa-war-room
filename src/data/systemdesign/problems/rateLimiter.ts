...
export const RATE_LIMITER: SDProblem = {
  ...
  <style>
    ...
    .rl-text { font-family: 'Space Mono', monospace; font-size: 11px; fill: #e8eaf0; }
    .rl-node { fill: #1a1e2a; stroke: #2e3446; stroke-width: 2; rx: 12; }
    .rl-arrow { stroke: #ff4d6d; stroke-width: 2; stroke-dasharray: 10 10; fill: none; animation: flowRight 1.5s linear infinite; }
    .rl-arrow-down { stroke: #ff4d6d; stroke-width: 2; stroke-dasharray: 10 10; fill: none; animation: flowDown 1.5s linear infinite; }
    .rl-label { font-size: 12px; fill: #8b8fa3; }
  </style>
  <defs>
  ...
  <!-- Client -->
  <rect class="rl-node" x="20" y="140" width="110" height="60" />
  <text class="rl-text" x="75" y="175" text-anchor="middle">Client</text>
  <!-- API Gateway -->
  <rect class="rl-node" x="200" y="140" width="130" height="60" />
  <text class="rl-text" x="265" y="175" text-anchor="middle">API Gateway</text>
  <!-- Rate Limiter -->
  <rect class="rl-node" x="400" y="50" width="140" height="60" />
  <text class="rl-text" x="470" y="85" text-anchor="middle">Rate Limiter</text>
  <!-- Redis -->
  <rect class="rl-node" x="620" y="50" width="120" height="60" />
  <text class="rl-text" x="680" y="85" text-anchor="middle">Redis</text>
  <text class="rl-label" x="680" y="100" text-anchor="middle">(Counters)</text>
  <!-- Rules Engine -->
  <rect class="rl-node" x="400" y="240" width="140" height="60" />
  <text class="rl-text" x="470" y="275" text-anchor="middle">Rules Engine</text>
  <!-- Backend -->
  <rect class="rl-node" x="620" y="240" width="120" height="60" />
  <text class="rl-text" x="680" y="275" text-anchor="middle">Backend API</text>
  <!-- Arrows -->
  <line class="rl-arrow" x1="130" y1="170" x2="200" y2="170" marker-end="url(#rl-arrow)" />
  <line class="rl-arrow" x1="265" y1="140" x2="400" y2="80" marker-end="url(#rl-arrow)" />
  <line class="rl-arrow" x1="540" y1="80" x2="620" y2="80" marker-end="url(#rl-arrow)" />
  <line class="rl-arrow-down" x1="470" y1="110" x2="470" y2="240" marker-end="url(#rl-arrow)" />
  <line class="rl-arrow" x1="330" y1="170" x2="620" y2="270" marker-end="url(#rl-arrow)" />
  <text class="rl-label" x="155" y="162">req</text>
  <text class="rl-label" x="310" y="105">check</text>
  <text class="rl-label" x="570" y="72">get/incr</text>
  <text class="rl-label" x="478" y="180">rules</text>
  <text class="rl-label" x="460" y="225">allowed</text>
</svg>`,
  },
  ...
  <style>
    .rl-text { font-family: 'Space Mono', monospace; font-size: 11px; fill: #e8eaf0; }
    .rl-bucket { fill: #1a1e2a; stroke: #ff4d6d; stroke-width: 2; rx: 8; }
    .rl-token { fill: #ff4d6d; opacity: 0.7; }
    .rl-window { fill: #1a1e2a; stroke: #2e3446; stroke-width: 2; }
    .rl-label { font-size: 12px; fill: #8b8fa3; }
    .rl-title { font-size: 12px; fill: #ff4d6d; font-weight: bold; }
  </style>
  <text class="rl-title" x="120" y="25">Token Bucket</text>
  <rect class="rl-bucket" x="80" y="40" width="120" height="160" />
  <circle class="rl-token" cx="120" cy="170" r="12" />
  <circle class="rl-token" cx="155" cy="170" r="12" />
  <circle class="rl-token" cx="120" cy="140" r="12" />
  <circle class="rl-token" cx="155" cy="140" r="12" />
  <circle class="rl-token" cx="120" cy="110" r="12" />
  <text class="rl-label" x="140" y="220" text-anchor="middle">5 tokens left</text>
  <text class="rl-label" x="140" y="235" text-anchor="middle">refill: 10/sec</text>
  <text class="rl-title" x="520" y="25">Sliding Window</text>
  <rect class="rl-window" x="400" y="40" width="150" height="120" />
  <text class="rl-label" x="475" y="70" text-anchor="middle">Prev Window</text>
  <text class="rl-text" x="475" y="95" text-anchor="middle">42 reqs</text>
  <text class="rl-label" x="475" y="120" text-anchor="middle">x 30% overlap</text>
  <rect class="rl-window" x="570" y="40" width="150" height="120" />
  <text class="rl-label" x="645" y="70" text-anchor="middle">Curr Window</text>
  <text class="rl-text" x="645" y="95" text-anchor="middle">18 reqs</text>
  <text class="rl-label" x="560" y="190" text-anchor="middle">Total: 42*0.3 + 18 = 30.6</text>
  <text class="rl-label" x="560" y="210" text-anchor="middle">Limit: 50 → ALLOW</text>
</svg>`,
    },
    {
...
<text class="rl-text" x="75" y="225" text-anchor="middle" font-family="Space Mono, monospace" font-size="10" fill="#ff4d6d">1. Request arrives</text>`,
    },
    {
      stepNumber: 2,
...
<text class="rl-text" x="265" y="225" text-anchor="middle" font-family="Space Mono, monospace" font-size="10" fill="#ff4d6d">2. Extract client ID</text>`,
    },
    {
      stepNumber: 3,
...
<text class="rl-text" x="680" y="135" text-anchor="middle" font-family="Space Mono, monospace" font-size="10" fill="#ff4d6d">3. INCR + check</text>`,
    },
    {
      stepNumber: 4,
...
<text class="rl-text" x="470" y="325" text-anchor="middle" font-family="Space Mono, monospace" font-size="10" fill="#ff4d6d">4. Check rule limit</text>`,
    },
    {
      stepNumber: 5,
...
<text class="rl-text" x="680" y="325" text-anchor="middle" font-family="Space Mono, monospace" font-size="10" fill="#00e676">5. ALLOWED → forward</text>`,
    },
    {
      stepNumber: 6,
...
<text class="rl-text" x="165" y="132" text-anchor="middle" font-family="Space Mono, monospace" font-size="11" fill="#ff4d6d" font-weight="bold">429</text>
<text class="rl-text" x="165" y="250" text-anchor="middle" font-family="Space Mono, monospace" font-size="10" fill="#ff4d6d">6. DENIED → 429</text>`,
    },
  ],
